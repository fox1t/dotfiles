...
echo "macOS Install Setup Script"
echo "By Maksim Sinik"
echo "Follow me on twitter! https://twitter.com/maksimsinik"
...
cd ~/ && curl -O https://raw.githubusercontent.com/fox1t/dotfiles/master/zsh/.zshrc && curl -O https://raw.githubusercontent.com/fox1t/dotfiles/master/zsh/.zshenv
...
echo ""
echo ""
echo -n "Check for and install available macOS updates, install, and automatically restart? (y/n)? "
read response
